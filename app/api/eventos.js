...
[   {
  ...
  sede: ["Puerto Montt", "Valdivia", "Patagonia"],
  display: 'auto'
...
},
{
  ...
  sede: ["Valdivia", "Puerto Montt", "Patagonia"],
  display: 'auto'
},
{
...
{
  description: "Período para que las Direcciones de Escuela (sedes Valdivia y Puerto Montt) y Jefaturas de Carrera (Campus Patagonia) presenten al Departamento de Aseguramiento de la Calidad e Innovación Curricular (DACIC) las modificaciones curriculares menores que involucren cambios en el Sistema Curricular, para ser implementados desde el primer semestre 2024.",
...
},//
{
  ...
  sede: ["Valdivia", "Patagonia", "Puerto Montt"],
  display: 'auto'
},
{
...
},//
{
  ...
  className: "Financiero",
  sem: "Semestre2",
  start: "2023-12-01", // Debes definir la fecha
  sede: ["Valdivia", "Puerto Montt", "Patagonia"],
  display: 'auto'
},//
{
